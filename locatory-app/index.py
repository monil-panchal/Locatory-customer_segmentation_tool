...
def navBar(input1):
    if current_user.is_authenticated:
        navBarContents = [
            dbc.NavItem(dbc.NavLink(html.Img(src='/assets/locatory-logo-removebg-preview.png',
                                             style={"height": 60, "width": 250}), href='/sales_dashboard')),
            dbc.NavItem(dbc.NavLink('Sales Dashboard',
                                    href='/sales_dashboard', style={"color": "orange"})),
            dbc.NavItem(dbc.NavLink('Demographic-Geographic Segmentation',
                                    href='/map_dashboard', style={"color": "orange"})),
            dbc.NavItem(dbc.NavLink('Default Combined Segmentation',
                                    href='/other_dashboard', style={"color": "orange"})),
            dbc.NavItem(dbc.NavLink('Custom Combined Segmentation',
